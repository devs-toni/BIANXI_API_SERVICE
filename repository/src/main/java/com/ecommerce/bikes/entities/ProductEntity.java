...
public class ProductEntity {
    ...
    public static ProductEntity toEntity(Product product, User user) {
        Product productWithoutLikes = product;
        productWithoutLikes.setLikes(Collections.emptyList());
        ...
        return new ProductEntity(
                ...
                product.getLikes().stream().map(like -> new LikeEntity(
                        like.getId(),
                        UserEntity.toEntity(user),
                        ProductEntity.toEntity(productWithoutLikes, null))
                ).toList()
        );
    }
