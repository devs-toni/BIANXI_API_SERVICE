...
public class VerifyUserUseCaseTest {
    ...
    @Test
    @DisplayName("WHEN user verify login THEN user is verified successfully")
    ...
    @Test
    @DisplayName("WHEN user verify login THEN throw exception because user doesn't exist")
    ...
    @Test
    @DisplayName("WHEN user verify login THEN throw exception because password is not correct")
